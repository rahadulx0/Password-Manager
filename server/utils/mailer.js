...
export async function sendOtpEmail(to, code, purpose) {
  const subject = purpose === 'signup'
    ? 'Verify your email - Vault'
    : 'Reset your password - Vault';
  ...
  const html = `
    <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: 460px; margin: 0 auto; padding: 40px 20px;">
      ...
      <h2 style="text-align: center; color: #111827; font-size: 22px; margin-bottom: 8px;">${heading}</h2>
      <p style="text-align: center; color: #6b7280; font-size: 15px; margin-bottom: 32px;">${message}</p>
